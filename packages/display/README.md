...
End-user component for the **True - False** content element in [Tailor CMS](https://github.com/tailor-cms/author).
...
```sh
npm install @tailor-cms/ce-true-false-display
```
...
```ts
import { Display } from '@tailor-cms/ce-true-false-display';
```
